...
export async function getRecommendedQuestion(params: RecommendedParams) {
  try {
    connectToDB();
    ...
    const totlaQuestion = await Question.countDocuments(query);
    ...
    const isNext = totlaQuestion > skipAmount + recommendedQuestions.length;
